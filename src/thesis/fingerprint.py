...
PD_SKEW = "PD Skewness"
PD_KURT = "PD Kurtosis"
PD_WEIBULL_A = "PD Weibull A"
PD_WEIBULL_B = "PD Weibull B"
TD_MAX = "TimeDiff Max"
...
TD_WEIBULL_A = "TimeDiff Weibull A"
TD_WEIBULL_B = "TimeDiff Weibull B"
...
def tu_graz(df: pd.DataFrame) -> pd.Series:
    ...
    finger[TD_WEIBULL_A], finger[TD_WEIBULL_B] = calc_weibull_params(
        df[data.TIMEDIFF][1:]
    )
